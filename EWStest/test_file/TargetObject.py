...
class ShapeRecognition:
    ...
    def run(self):
        while True:
            ...
            farthest_flag_center = None  # 가장 먼 깃발의 중점값을 저장할 변수
            ...
            for green_box in self.green_boxes:
                ...
                if flag_centers:
                    ...
                    farthest_flag_center_candidate = min(flag_centers, key=lambda center: center[1])

                    # 먼 깃발 선택
                    distance = abs(farthest_flag_center_candidate[0] - (x + w // 2))
            ...
            if farthest_flag_center:
                green_center_x = frame.shape[1] // 2  # 화면 가로 중앙
                cv2.line(frame, (green_center_x, frame.shape[0]), farthest_flag_center, (0, 255, 0), 2)
