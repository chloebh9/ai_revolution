        ...
        while True:
            ...
            if not self.green_boxes:
                ...
                for cnt in yellow_contours:
                    ...
                    if area > largest_yellow_area:  # 현재 가장 큰 노랑 영역보다 큰 경우
                        largest_yellow_area = area
                        largest_yellow_contour = cnt

                if largest_yellow_contour is not None:
                    x, y, w, h = cv2.boundingRect(largest_yellow_contour)
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 255, 0), 2)
                    cv2.putText(frame, 'Largest Yellow Area', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
