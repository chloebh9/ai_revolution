...
class FlagxCenterMeasurer:
    ...
    def run(self):
        ...
        while True:
            ...
            low_yellow = np.array([23, 85, 121])
            high_yellow = np.array([36, 200, 230])
            yellow_mask = cv2.inRange(hsv_frame, low_yellow, high_yellow)
            ...
            # high_yellow = np.array([97, 255, 255])
            # yellow_mask = cv2.inRange(hsv_frame, low_yellow, high_yellow)
            # lower4 = np.array([ 30 , 107 , 100 ])
            # upper4 = np.array([ 36 , 127 , 200 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower4 , upper4 )
            # lower5 = np.array([ 28 , 238 , 20 ])
            # upper5 = np.array([ 34 , 255 , 120 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower5 , upper5 )
            # lower6 = np.array([ 27 , 241 , 20 ])
            # upper6 = np.array([ 33 , 255 , 120 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower6 , upper6 )
            # lower7 = np.array([ 26 , 133 , 96 ])
            # upper7 = np.array([ 32 , 153 , 196 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower7 , upper7 )
            # lower8 = np.array([ 33 , 79 , 88 ])
            # upper8 = np.array([ 39 , 99 , 188 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower8 , upper8 )
            # lower9 = np.array([ 31 , 93 , 103 ])
            # upper9 = np.array([ 37 , 113 , 203 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower9 , upper9 )
            # lower10 = np.array([ 27 , 238 , 22 ])
            # upper10 = np.array([ 33 , 255 , 122 ])
            # yellow_mask += cv2.inRange(hsv_frame, lower10 , upper10 )
            # lower11 = np.array([ 27 , 140 , 69 ])
