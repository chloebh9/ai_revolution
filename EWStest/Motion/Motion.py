...
class Motion:
    ...
    def set_head(self, dir, angle=0):
        ...
        dir_list = {
            ...
            "LEFT": {30: 56, 40: 57, 45: 58, 54: 59, 60: 60, 90: 61, 46: 103, 62: 105},
            "RIGHT": {30: 62, 45: 63, 54: 64, 60: 65, 69: 66, 90: 67, 61: 104, 57: 106},
        }
    ...
    # 옆으로 이동 (90, 91)
    def walk_side(self, dir, loop=1, sleep=0.4):
        """
        dir: {LEFT, RIGHT} - 이동 
        """
